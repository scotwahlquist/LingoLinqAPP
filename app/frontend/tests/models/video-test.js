...
describe('Video', function() {
  describe('filename', function() {
    ...
    it("should return filename if found in URL path, ignoring query params", function() {
      var video = LingoLinqAAC.store.createRecord('video', {url: 'http://www.videos.com/video.avi'});
    ...
    it("should provide readable string for data URIs", function() {
      var video = LingoLinqAAC.store.createRecord('video', {url: 'data:video/avi;abababa'});
