...
describe("persistence", function() {
  ...
  function push_board(callback) {
    db_wait(function() {
      LingoLinqAAC.store.push({data: {type: 'board', id: '1234', attributes: {
        id: '1234',
        name: 'Best Board'
      }}});
      var record = null;
      LingoLinqAAC.store.find('board', '1234').then(function(res) {
        record = res;
      });
      var _this = this;
  ...
  describe("find", function() {
    ...
    it("should mark recent results as fresh", function() {
      db_wait(function() {
        ...
        waitsFor(function() { return record; });
        runs(function() {
          var rec = LingoLinqAAC.store.createRecord('board', record);
          expect(record.hat).toEqual(rnd);
    ...
    it("should update freshness of results as applicable", function() {
      db_wait(function() {
        ...
        waitsFor(function() { return record; });
        runs(function() {
          board = LingoLinqAAC.store.createRecord('board', record);
          expect(record.hat).toEqual(rnd);
    ...
    it("should mark ajax-retrieved results as fresh", function() {
      db_wait(function() {
        ...
        LingoLinqAAC.store.findRecord('board', '1234').then(function(res) {
          record = res;
        });
        waitsFor(function() { return record; });
        runs(function() {
    ...
    it("should mark retrieved attribute for sideloaded results", function() {
      db_wait(function() {
        ...
        runs(function() {
          expect(record.get('name')).toEqual('Cool Board');
          expect(record.get('fresh')).toEqual(true);
          var img = LingoLinqAAC.store.peekRecord('image', '1111');
  ...
  describe("find_recent", function() {
    it("should look up local copies of recent boards", function() {
      ...
      stub(LingoLinqAAC.store, 'push', function(obj) {
        stored.push(obj);
        return obj;
      });
  ...
  describe("convert_model_to_json", function() {
    it("should serialize a record", function() {
      var board = LingoLinqAAC.store.createRecord('board', {key: 'ok/cool', name: "My Awesome Board"})._createSnapshot();
      var json = persistence.convert_model_to_json(LingoLinqAAC.store, 'board', board);
    ...
    it("should call mimic_server_processing if defined", function() {
      var called = false;
      var board = LingoLinqAAC.store.createRecord('board', {key: 'ok/cool', name: "My Awesome Board"})._createSnapshot();
      var type = LingoLinqAAC.store.modelFor('board');
...
//     });
  ...
  describe("DSAdapter", function() {
    describe("findRecord", function() {
      it("should return a promise", function() {
        var res = LingoLinqAAC.store.find('board', '1234');
        expect(res.then).not.toEqual(null);
      });
      it("should make an ajax query and find the record", function() {
        ...
        var result = null;
        LingoLinqAAC.store.find('board', '987').then(function(res) {
          result = res;
        });
        waitsFor(function() { return result; });
        runs(function() {
      ...
      it("should persist the record to the local db", function() {
        db_wait(function() {
          ...
          var result = null;
          LingoLinqAAC.store.find('board', '9876').then(function(res) {
            result = res;
          });
          waitsFor(function() { return result; });
          runs(function() {
      ...
      it("should not wait for remote response nonsense when finding after getting a local result", function() {
        db_wait(function() {
          ...
          runs(function() {
            ...
            LingoLinqAAC.store.findRecord('board', '9876').then(function(res) {
              second_result = res;
      ...
      it("should skip straight to a db lookup when finding a local id", function() {
        db_wait(function() {
          ...
          var result = null;
          LingoLinqAAC.store.find('board', 'tmp_abcd').then(function(res) {
            result = res;
          });
          waitsFor(function() { return result; });
          runs(function() {
      ...
      it("should reject if offline and not found in the local db", function() {
        db_wait(function() {
          ...
          var result = null;
          LingoLinqAAC.store.find('board', '8765').then(null, function(res) {
            result = res;
          });
          waitsFor(function() { return result; });
          runs(function() {
      ...
      it("should find a locally-created record while offline", function() {
        db_wait(function() {
          ...
          var board = LingoLinqAAC.store.createRecord('board', {key: 'ok/cool', name: "My Awesome Board"});
...
//   },
    describe("findQuery", function() {
      it("should make an ajax call if online", function() {
        ...
        LingoLinqAAC.store.query('board', {user_id: 'example', starred: true, public: true}).then(function(res) {
  ...
  describe('push_records', function() {
    it('should not call find if all ids already pushed', function() {
      var a = LingoLinqAAC.store.push({data: {type: 'image', id: 'a', attributes: {id: 'a', url: 'http://www.example.com/a.png'}}});
      var b = LingoLinqAAC.store.push({data: {type: 'image', id: 'b', attributes: {id: 'b', url: 'http://www.example.com/b.png'}}});
      var records = null;
      var called = false;
  ...
  describe("check_for_needs_sync", function() {
    ...
    it("should get called when online status changes", function() {
      persistence.set('online', false);
      stub(LingoLinqAAC, 'sync_testing', true);
