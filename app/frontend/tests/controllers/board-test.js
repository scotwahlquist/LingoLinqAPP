...
//
//     if(this.get('license')) {
//       this.set('license.copyright_notice_url', LingoLinq-AAC.licenseOptions.license_url(this.get('license.type')));
//     }
//
...
//     var topHeight = LingoLinq-AAC.headerHeight + 5;
...
//           }
//         }
//         var image_height = button_height - currentLabelHeight - LingoLinq-AAC.boxPad - (inner_pad * 2);
//         var image_width = button_width - LingoLinq-AAC.boxPad - (inner_pad * 2);
//
//         if(_this.get('text_size') == 'really_small_text') {
//           if(currentLabelHeight > 0) {
//             image_height = image_height + currentLabelHeight - LingoLinq-AAC.labelHeight + 25;
//           }
//         } else if(_this.get('text_size') == 'small_text') {
//           if(currentLabelHeight > 0) {
//             image_height = image_height + currentLabelHeight - LingoLinq-AAC.labelHeight + 10;
//           }
//         }
//
