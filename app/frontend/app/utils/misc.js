  ...
  return new RSVP.Promise(function(resolve, reject) {
    ...
    var find_next = function(type, opts) {
      if(type.match(/\/api\//)) {
        ...
        LingoLinqAAC.store.query(type, opts).then(function(list) {
...
RSVP.all_wait = function(promises) {
  return new RSVP.Promise(function(resolve, reject) {
    ...
    var done = function() {
      var really_done = !LingoLinqAAC.testing && failures.length > 0;
      really_done = really_done || (!LingoLinqAAC.all_wait && failures.length > 0);
