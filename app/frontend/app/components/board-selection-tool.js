...
export default Component.extend({
  ...
  load_boards: function() {
    ...
    LingoLinqAAC.store.query('board', {public: true, starred: true, user_id: app_state.get('domain_board_user_name'), per_page: 20, category: 'layouts'}).then(function(data) {
  ...
  actions: {
    ...
    set_org_board: function(brd_key) {
      var _this = this;
      LingoLinqAAC.store.findRecord('board', brd_key).then(function(board) {
