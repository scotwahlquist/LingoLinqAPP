...
LingoLinqAAC.Image = DS.Model.extend({
  didLoad: function() {
  ...
  skinned: computed('url', function() {
    return LingoLinqAAC.Board.is_skinned_url(this.get('url'));
  }),
  ...
  personalizing_url: function(skip_alternates) {
    ...
    return LingoLinqAAC.Image.personalize_url(url, this.get('app_state.currentUser.user_token'), this.get('app_state.referenced_user.preferences.skin'), LingoLinqAAC.Image.unskins[this.get('id')]);
  },
  ...
  checkForDataURL: function() {
    ...
    if(!this.get('data_url_no_sym') && LingoLinqAAC.remote_url(this.get('personalized_url_without_preferred_symbols'))) {
    ...
    if(!this.get('data_url') && LingoLinqAAC.remote_url(this.get('personalized_url'))) {
...
LingoLinqAAC.Image.reopenClass({
  personalize_url: function(url, token, skin, unskin) {
    ...
    if(skin && skin != 'default') {
      ...
      res = LingoLinqAAC.Board.skinned_url(url, which_skin, unskin);
    }
    return res;
  },
...
export default LingoLinqAAC.Image;
