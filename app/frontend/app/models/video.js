...
LingoLinqAAC.Video = DS.Model.extend({
  didLoad: function() {
  ...
  checkForDataURL: function() {
    ...
    var _this = this;
    if(!this.get('data_url') && LingoLinqAAC.remote_url(this.get('url')) && !persistence.online) {
...
LingoLinqAAC.Video.reopenClass({
...
export default LingoLinqAAC.Video;
