...
export default modal.ModalController.extend({
  opening: function() {
    ...
    if(_this.get('model.profile_id')) {
      ...
      // LingoLinqAAC.store.findRecord('profile', _this.get('model.profile_id')).then(function(pt) {
  ...
  actions: {
    ...
    lookup: function() {
      ...
      if(id) {
        ...
        _this.set('browse_state', null);
        LingoLinqAAC.store.findRecord('profile', _this.get('find_profile_id')).then(function(pt) {
          _this.set('lookup_state', null);
